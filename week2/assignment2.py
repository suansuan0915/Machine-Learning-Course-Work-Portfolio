...
def load_unicef_data():
    ...
    """
    # fname = '/Users/wanyi/Documents/CMPT_726/assignments/A2_data&code/SOWC_combined_simple.csv'
    fname = 'SOWC_combined_simple.csv'

    # Uses pandas to help with string-NaN-numeric data.
    data = pd.read_csv(fname, na_values='_', engine='python')
...
def normalize_data(x):
    ...
    """
    mvec = x.mean(0)  # 0: (axis=0) along each column
    stdvec = x.std(axis=0)
